...
# Mine
g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I ${PACKAGE_PATH}/tensorflow/include -I ${CUDA_INCLUDE} -I ${PACKAGE_PATH}/tensorflow/include/external/nsync/public -lcudart -L ${CUDART} -L${PACKAGE_PATH}/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
